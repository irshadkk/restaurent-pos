...
public class WaiterSelectorDialog extends POSDialog {

	private final WaiterSelector customerSelector;

	public WaiterSelectorDialog(WaiterSelector customerSelector) throws HeadlessException {
		super(Application.getPosWindow(), true);
		this.customerSelector = customerSelector;

		TitlePanel titlePane = new TitlePanel();
		titlePane.setTitle(Messages.getString("Select Waiter")); //$NON-NLS-1$
	...
	public Waiter getSelectedWaiter() {
	...
	public void setCustomer(Waiter waiter) {
		customerSelector.setCustomer(waiter); 
	}
