...
public class WaiterExplorer extends TransparentPanel {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog
							.showMessage(WaiterExplorer.this, com.floreantpos.POSConstants.CONFIRM_DELETE, com.floreantpos.POSConstants.DELETE) == ConfirmDeleteDialog.YES) {
						Customer customer = customerList.get(index);
						CustomerDAO dao = new CustomerDAO();
						dao.delete(customer);
