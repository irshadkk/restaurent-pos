...
public abstract class WaiterSelector extends JPanel {
...
//		}
	...
	public abstract Waiter getSelectedCustomer();
	...
	public void setCustomer(Waiter customer) {
		this.waiter = customer;
	}

	public Waiter getCustomer() {
		return waiter;
	}
