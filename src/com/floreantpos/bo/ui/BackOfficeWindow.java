...
import com.floreantpos.inventory.ShowInventoryBrowserAction;
...
public class BackOfficeWindow extends javax.swing.JFrame {
    ...
    private void createInventoryMenu(JMenuBar menuBar) {
        ...
        inventtoryMenu = new JMenu("Inventroy"); //$NON-NLS-1$
        inventtoryMenu.add(new ShowTableBrowserAction());
         inventtoryMenu.add(new ShowInventoryBrowserAction());

        menuBar.add(inventtoryMenu);
    ...
    public JMenu getInventtoryMenu() {
        return inventtoryMenu;
    }
    ...
    public void setInventtoryMenu(JMenu inventtoryMenu) {
        this.inventtoryMenu = inventtoryMenu;
    }
	//	public static BackOfficeWindow getInstance() {
    //		if (instance == null) {
    //			instance = new BackOfficeWindow();
