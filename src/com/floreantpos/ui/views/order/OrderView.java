...
import com.floreantpos.waiter.WaiterSelectorDialog;
import com.floreantpos.waiter.WaiterSelectorFactory;
...
public class OrderView extends ViewPanel implements PaymentListener, TicketEditListener {
    ...
    protected void selectWaiter() {
        WaiterSelectorDialog dialog = WaiterSelectorFactory.createWaiterSelectorDialog(currentTicket.getOrderType());
        dialog.setCreateNewTicket(false);
        if (currentTicket != null) {
            dialog.setTicket(currentTicket);
        }
...
//            currentTicket.setCustomer(dialog.getSelectedCustomer());
            ...
            btnWaiter.setText("<html><body><center>WAITER<br>\"" + dialog.getSelectedWaiter().getFirstName() + "\"</center></body></html>");
    ...
    private void showDefaultView() {
        /*enable this block for supermarket view
        removeAll();
        ...
        */
        ...
        /*enable this block for restaurent view*/
        removeAll();
        setVisibleButtonForOrderView();
        ticketSummaryView.setVisible(false);
        add(categoryView, java.awt.BorderLayout.EAST);
    ...
    public void updateView() {
        ...
        btnWaiter.setText(POSConstants.WAITER_SELECTION_BUTTON_TEXT);
        if (currentTicket != null) {
            OrderType type = currentTicket.getOrderType();
