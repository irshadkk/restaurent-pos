...
public class TicketView extends JPanel {
                ...
                if (!addMenuItemByBarcode(dialog.getValue())) {
                    if (!addMenuItemByItemId(dialog.getValue())) {
                        if (!addMenuItemByName(dialog.getValue())) {
                            if (!addMenuItemByNameNameOrItsSubstring(dialog.getValue())) {
    ...
    private boolean addMenuItemByNameNameOrItsSubstring(String name) {

        MenuItemDAO dao = new MenuItemDAO();

        MenuItem menuItem = dao.getMenuItemByNameOrItsSubstring(name);
    ...
    private boolean addMenuItemByName(String barcode) {

        MenuItemDAO dao = new MenuItemDAO();

        MenuItem menuItem = dao.getMenuItemByName(barcode);
